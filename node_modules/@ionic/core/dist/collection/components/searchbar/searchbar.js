...
export class Searchbar {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, createColorClasses(this.color), { [`${this.mode}`]: true, 'searchbar-animated': animated, 'searchbar-disabled': this.disabled, 'searchbar-no-animate': animated && this.noAnimate, 'searchbar-has-value': this.hasValue(), 'searchbar-left-aligned': this.shouldAlignLeft, 'searchbar-has-focus': this.focused, 'searchbar-should-show-cancel': this.shouldShowCancelButton() })
        };
    }
    render() {
        const clearIcon = this.clearIcon || (this.mode === 'ios' ? 'ios-close-circle' : 'md-close');
        const searchIcon = this.searchIcon;
        const cancelButton = !isCancelButtonSetToNever(this.showCancelButton) && (h("button", { type: "button", tabIndex: this.mode === 'ios' && !this.shouldShowCancelButton() ? -1 : undefined, onMouseDown: this.onCancelSearchbar, onTouchStart: this.onCancelSearchbar, class: "searchbar-cancel-button" },
    ...
    static get properties() { return {
        ...
        "showCancelButton": {
            ...
            "watchCallbacks": ["showCancelButtonChanged"]
        },
        "spellcheck": {
            "type": Boolean,
            "attr": "spellcheck"
