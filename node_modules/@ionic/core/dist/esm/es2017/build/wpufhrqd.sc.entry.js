...
import { GESTURE_CONTROLLER } from './chunk-ab1eff20.js';
...
class MenuButton {
    ...
    static get style() { return ".sc-ion-menu-button-md-h{--background:transparent;--color-focused:var(--color);--border-radius:initial;--padding-top:0;--padding-bottom:0;color:var(--color);text-align:center;text-decoration:none;text-overflow:ellipsis;text-transform:none;white-space:nowrap;-webkit-font-kerning:none;font-kerning:none}.button-native.sc-ion-menu-button-md{border-radius:var(--border-radius);font-family:inherit;font-size:inherit;font-style:inherit;font-weight:inherit;letter-spacing:inherit;text-decoration:inherit;text-overflow:inherit;text-transform:inherit;text-align:inherit;white-space:inherit;color:inherit;margin-left:0;margin-right:0;margin-top:0;margin-bottom:0;padding-left:var(--padding-start);padding-right:var(--padding-end);padding-top:var(--padding-top);padding-bottom:var(--padding-bottom);-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;display:-ms-flexbox;display:flex;position:relative;-ms-flex-flow:row nowrap;flex-flow:row nowrap;-ms-flex-negative:0;flex-shrink:0;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;width:100%;height:100%;border:0;outline:none;background:var(--background);line-height:1;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;z-index:0;-webkit-appearance:none;-moz-appearance:none;appearance:none}\@supports ((-webkit-margin-start:0) or (margin-inline-start:0)) or (-webkit-margin-start:0){.button-native.sc-ion-menu-button-md{padding-left:unset;padding-right:unset;-webkit-padding-start:var(--padding-start);padding-inline-start:var(--padding-start);-webkit-padding-end:var(--padding-end);padding-inline-end:var(--padding-end)}}ion-icon.sc-ion-menu-button-md{margin-left:0;margin-right:0;margin-top:0;margin-bottom:0;padding-left:0;padding-right:0;padding-top:0;padding-bottom:0;pointer-events:none}\@media (any-hover:hover){.sc-ion-menu-button-md-h:hover   .button-native.sc-ion-menu-button-md{background:var(--background-hover);color:var(--color-hover)}}.ion-focused.sc-ion-menu-button-md-h   .button-native.sc-ion-menu-button-md{background:var(--background-focused);color:var(--color-focused)}.ion-color.sc-ion-menu-button-md-h   .button-native.sc-ion-menu-button-md{color:var(--ion-color-base)}ion-toolbar.sc-ion-menu-button-md-h:not(.ion-color), ion-toolbar:not(.ion-color)   .sc-ion-menu-button-md-h{color:var(--ion-toolbar-color,var(--color))}.sc-ion-menu-button-md-h{--background-focused:rgba(66,66,66,0.24);--background-hover:rgba(66,66,66,0.08);--border-radius:50%;--color:initial;--padding-start:8px;--padding-end:8px;width:48px;height:48px}ion-icon.sc-ion-menu-button-md{font-size:24px}\@media (any-hover:hover){.ion-color.sc-ion-menu-button-md-h:hover   .button-native.sc-ion-menu-button-md{background:rgba(var(--ion-color-base-rgb),.08)}}.ion-color.ion-focused.sc-ion-menu-button-md-h   .button-native.sc-ion-menu-button-md{background:rgba(var(--ion-color-base-rgb),.24);color:var(--ion-color-base)}"; }
    static get styleMode() { return "md"; }
}
...
class MenuController {
    ...
    async _createAnimation(type, menuCmp) {
        ...
        const animation = await import('./chunk-1d62a940.js')
