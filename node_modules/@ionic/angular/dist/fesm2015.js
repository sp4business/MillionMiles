...
class StackController {
    ...
    setActive(enteringView) {
        ...
        () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield cleanupAsync(enteringView, views, viewsSnapshot, this.location);
            return {
                enteringView,
                direction,
                animation,
...
class IonRouterOutlet {
     ...
     * @param {?=} parentOutlet
     */
    constructor(parentContexts, location, resolver, name, tabs, changeDetector, config, navCtrl, commonLocation, elementRef, router, zone, activatedRoute, parentOutlet) {
